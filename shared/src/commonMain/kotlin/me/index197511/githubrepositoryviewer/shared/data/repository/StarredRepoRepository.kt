...
import me.index197511.githubrepositoryviewer.shared.data.resource.local.StarredRepositoryDatabase
...
class StarredRepoRepository(private val database: StarredRepositoryDatabase) :
